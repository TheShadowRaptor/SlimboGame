...
function onReady(e) {
    ...
    for (let i = 0; i < Constants_1.TILE_MAX; i++) {
        yPos = 660;
        xPos = xPos + 64;
        tile[i] = new Tile_1.Tile(stage, assetManager);
        tile[i].positionMe(xPos, yPos);
        tile[i].showMe();
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("d96df1fc6ed0abf089d4")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.a3679f09cd37edde4c04.hot-update.js.map