...
function monitorCollisions() {
    if ((0, Toolkit_1.boxHit)(player.sprite, tile.sprite)) {
        player.state == Character_1.Character.STATE_GROUNDED;
    }
    if (player.state != Character_1.Character.STATE_JUMPING || Character_1.Character.STATE_GROUNDED) {
        player.state == Character_1.Character.STATE_FALLING;
    }
}
function onTick(e) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("8caac69836910c7d5783")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.9c3d36aab3dceb8b7031.hot-update.js.map