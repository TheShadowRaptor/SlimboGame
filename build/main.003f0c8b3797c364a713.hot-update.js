...
function onReady(e) {
    ...
    for (let i = 0; i < Constants_1.TILE_MAX; i++) {
        ...
        x = +64;
        y = 720;
        tile.push(new Tile_1.Tile(stage, x, y, assetManager));
    }
    for (let newTile of tile) {
        newTile.showMe();
    }
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("86bf14b1485211d4bd4f")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.003f0c8b3797c364a713.hot-update.js.map