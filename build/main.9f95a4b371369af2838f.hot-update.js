...
class Player extends Character_1.Character {
    ...
    monitorAnimations() {
        if (this.oneTime == true) {
            ...
            if (this.direction == Character_1.Character.LEFT) {
                this._sprite.gotoAndPlay("CharacterSpritesheet/Player/Left");
                this.oneTime = false;
            }
            else if (this.direction == Character_1.Character.RIGHT) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("c71539cb6c71043cd4d0")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.9f95a4b371369af2838f.hot-update.js.map