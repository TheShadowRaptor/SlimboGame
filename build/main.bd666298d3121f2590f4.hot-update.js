...
class AssetManager {
    constructor(stage) {
        ...
        this.CharacterSpritesheetsJSON = [];
    ...
    onLoaded(e) {
        ...
        switch (e.item.type) {
            case "json":
                ...
                this.CharacterSpritesheetsJSON[spriteSheetID] = e.result;
                break;
            case "image":
                let id = e.item.id;
                let image = e.result;
                let data = this.CharacterSpritesheetsJSON[id];
                data.images = [image];
                let spriteSheet = new createjs.SpriteSheet(data);
                this.CharacterSpritesheet[id] = spriteSheet;
                break;
        }
    }
    onError(e) {
    ...
    getSpriteSheet(spriteSheetID) {
        return this.CharacterSpritesheet[spriteSheetID];
    }
    loadAssets(manifest) {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("0a5036de28e32937b1f0")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=main.bd666298d3121f2590f4.hot-update.js.map